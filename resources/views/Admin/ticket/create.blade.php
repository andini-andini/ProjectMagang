                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="asset" id="asset"
                                            class="form-control @error('asset') is-invalid @enderror" name="asset" value=""
                                            autocomplete="asset">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="recipients" id="recipients"
                                            class="form-control @error('recipients') is-invalid @enderror" name="recipients"
                                            value="" autocomplete="recipients">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option style="color: green; " value="Use">Use</option>
                                            <option style="color: blue; " value="New">New</option>
                                        </select>
                                    </div>
                                    @error('status')
                                        <small style="color: red; ">{{ $message }}</small>
